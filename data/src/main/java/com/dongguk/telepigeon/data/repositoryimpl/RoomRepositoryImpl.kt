...
class RoomRepositoryImpl @Inject constructor(
    ...
    override suspend fun getRooms(): Result<List<HomeRoomModel>> = runCatching {
        roomRemoteDataSource.getRooms().data.rooms.map { responseGetRoomDto ->
            responseGetRoomDto.toHomeRoomModel()
        }
    }

    override suspend fun postRoom(name: String): Result<Unit> = runCatching {
    ...
    override suspend fun getRoomInfo(roomId: Int): Result<RoomInfoModel> = runCatching {

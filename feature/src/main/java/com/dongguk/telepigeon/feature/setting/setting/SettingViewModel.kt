...
class SettingViewModel @Inject constructor() : ViewModel() {
    val dummyRoomInfoModel = RoomInfoModel(
        code = "1233972abdce",
        name = "디스이즈방이름"
    )

    val dummyRoomKeywordModel = RoomKeywordModel(
        keywords = "운동, 영양제, 밥"
    )

    val dummyRoomKeywordExtraModel = RoomKeywordExtraModel(
        gender = "남성",
        ageRange = "20대",
        relation = "자식"
    )

    val dummyRoomWorryModel = listOf(
        RoomWorryModel(
            name = "영양제 챙겨먹기",
